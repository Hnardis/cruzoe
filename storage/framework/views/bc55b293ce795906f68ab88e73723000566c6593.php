...
<tr>
        <th> <img src="<?php echo e(asset('storage/'.$resultaBF->bea_cheminImage)); ?>" width="100px" height="50px"> </th>
         
        <th> <?php echo e($resultaBF->bea_nom); ?> </th> 
        <th> <?php echo e($resultaBF->bf_prix); ?> </th> 
        <th> <?php echo e($resultaBF->bf_taille); ?> </th>
        <th> <?php echo e($resultaBF->bea_dureeExtrait); ?></th>
