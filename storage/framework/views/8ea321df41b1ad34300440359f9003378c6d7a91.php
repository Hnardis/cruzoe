...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Etape 1 : Modifier un Sample</div>
                <div class="panel-body">
                    
                    <?php echo Form::open(array('action' => 'AddSampleController@editSample','enctype' => 'multipart/form-data', 'class' => 'form-horizontal')); ?>
 ...
 <div class="form-group<?php echo e($errors->has('sample') ? ' has-error' : ''); ?>">
                    ...
                    <div class="text-center">
                        <?php echo e(Form::submit('Rafraichir', array('class' => 'btn btn-success'))); ?>
