...
<div class="container">
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::open(array('action' => 'AddSampleController@editSample','enctype' => 'multipart/form-data', 'class' => 'form-horizontal')) !!}
 ...
 <div class="form-group{{ $errors->has('sample') ? ' has-error' : '' }}">
                    ...
                    <div class="text-center">
                        {{ Form::submit('Rafraichir', array('class' => 'btn btn-success')) }}
                    </div>
